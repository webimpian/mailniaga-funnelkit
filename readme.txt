...
Streamline your WordPress email delivery with Mail Niaga SMTP & API integration. Boost email deliverability and ensure reliable SMTP service.

== Description ==

Mail Niaga SMTP is a powerful WordPress plugin that integrates your website with Mail Niaga's SMTP and API services. This plugin enhances your email deliverability, provides tracking capabilities, and ensures a reliable SMTP service for all your outgoing emails.
...
This plugin connects to Mail Niaga's endpoint to secure email processing for your WordPress site. It seamlessly integrates with the WordPress core wp_mail() function to ensure all your site's emails are sent through Mail Niaga's reliable SMTP servers or API.
...
* Option to use either SMTP or API for sending emails
...
You can choose between SMTP and API methods. SMTP is the traditional method and works well in most cases. The API method may offer improved speed and efficiency, especially for sites that send a high volume of emails.
